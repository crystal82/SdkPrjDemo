package com.uascent.tx.sdk.jxtxwifisdk.base.exception;

import android.content.Context;
import android.os.Build;

import com.uascent.tx.sdk.jxtxwifisdk.base.utils.Activitystack;
import com.uascent.tx.sdk.jxtxwifisdk.base.utils.FileUtil;
import com.uascent.tx.sdk.jxtxwifisdk.base.utils.StringUtils;
...
public class AppUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        String errorLog = obtainErrorLog(mContext, ex);
        saveLog(mContext, name, errorLog);
        mDefaultUncaughtExceptionHandler.uncaughtException(thread, ex);
    }

    public static String obtainErrorLog(Context context, Throwable ex) {
        ...
        for (int i = 0; i < Activitystack.getActivityList().size(); i++) {
            sbLog.append(i + "-" + Activitystack.getActivityList().get(i)
    ...
    public static String obtainBasicInfoLog(Context context, String info) {
        final String lineSeperator = "-------------------------------\n\n";
        StringBuffer sbLog;
    ...
    public static void saveLog(Context context, String logName, String log) {
        FileWriter  fw = null;
        PrintWriter pw = null;
        try {
            File file = FileUtil.createFileDir(context, FileUtil.LOG_PATH);
            String logFilePath = file.getAbsolutePath() + File.separator +
                    logName + "_" + System.currentTimeMillis() + ".dt";
